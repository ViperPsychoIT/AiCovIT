...
mdxnet_models_dir = BASE_DIR / '/content/drive/MyDrive/mdxnet_models'
rvc_models_dir = BASE_DIR / '/content/drive/MyDrive/rvc_models'
...
if __name__ == '__main__':
    ...
    for model in mdx_model_names:
        print(f'Download del modello {model}...')
    ...
    print('Tutti i modelli sono stati scaricati!')
